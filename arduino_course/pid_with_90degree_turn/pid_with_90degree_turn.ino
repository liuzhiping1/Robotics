...
float p = 0.8, i = 0.68, d = 1; //will differ, change the values according to the arena
float pid;
int e = 0, pe = 0;
int lmt1 = 3, lmt2 = 5, rmt1 = 6, rmt2 = 11; // change these values if the motors are going reverse
int init_speed = 100;
